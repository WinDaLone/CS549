...
public interface IDHTNode {
	...
	public final static String BINDING_CHANGE_EVENT = "binding-change";
	
	public void listenOn(String key, EventListener listener) throws Failed;
	// TODO: listen on new node
	public void listenChange(NodeInfo pred, String key, EventListener listener) throws Failed;
