...
public class ProxyContext extends ContextBase {
	...
	// These parts are server's proxy context send message to the client
	@Override
	public void msg(String m) throws IOException {
		// TODO done display the message on the remote client console
		sender.sendText(m);
	}
	...
	public void err(Throwable t) throws IOException {
		// TODO done print the stack trace on the remote client console
		sender.sendText(t.getMessage() + "\n");
		//try {
		//	sender.sendObject(new String[] { t.getMessage() });
